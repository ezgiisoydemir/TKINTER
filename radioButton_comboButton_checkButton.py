# -*- coding: utf-8 -*-
"""
Created on Tue Mar 15 13:46:42 2022
...
window.geometry("500x400") # windowsize x*y
...
#radio button
method = tk.StringVar()
tk.Radiobutton(window , text = "method1: " , value = "1" , activeforeground = "red" , 
               bg = "green" , height = 5 , width = 5 , borderwidth = 15 , variable = method).grid(row = 1 , column = 0)

tk.Radiobutton(window , text = "method2: " , value = "2" , activebackground = "red" , 
               bg = "green" , height = 5 , width = 5 , borderwidth = 15 , variable = method).grid(row = 1 , column = 1 , pady = 15)
