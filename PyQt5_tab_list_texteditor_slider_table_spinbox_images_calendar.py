...
class Window(QWidget):
    ...
    def tabs(self):
        ...
        self.tab1.setLayout(hbox2)
        
        self.tab.addTab(self.tab1 , "First")
        self.tab.addTab(self.tab1 , "Second")
        self.tab.addTab(self.tab1 , "Third")
    ...
    def table(self):
        ...
        self.table.setHorizontalHeaderItem(0, QTableWidget("method1"))
        self.table.setHorizontalHeaderItem(1, QTableWidget("method2"))
